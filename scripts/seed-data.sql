...
INSERT INTO opportunities (id, campaign_id, account_id, name, value, stage, probability, grade, owner, expected_close_date, created_at) VALUES
  ('o0000000-0001-4000-a000-000000000001', 'c0000000-0001-4000-a000-000000000001', 'a0000000-0001-4000-a000-000000000001', 'KCM WAN Expansion Phase 2', 280000, 'Negotiation', 75, 'Gold', 'Mwape Kasonde', '2026-08-15', '2026-05-10'),
  ('o0000000-0001-4000-a000-000000000002', 'c0000000-0001-4000-a000-000000000003', 'a0000000-0001-4000-a000-000000000002', 'Madison Cloud Migration', 95000, 'Qualified', 45, 'Silver', 'Thandiwe Mumba', '2026-09-01', '2026-04-20'),
  ('o0000000-0001-4000-a000-000000000003', 'c0000000-0001-4000-a000-000000000002', NULL, 'TechHub 100Mbps Dedicated', 48000, 'Qualified', 60, 'Silver', 'Mwape Kasonde', '2026-07-30', '2026-06-01'),
  ('o0000000-0001-4000-a000-000000000004', 'c0000000-0001-4000-a000-000000000005', 'a0000000-0001-4000-a000-000000000005', 'ZANACO Branch Refresh', 310000, 'Closed Won', 100, 'Platinum', 'Thandiwe Mumba', '2026-03-15', '2026-01-20'),
  ('o0000000-0001-4000-a000-000000000005', 'c0000000-0001-4000-a000-000000000001', 'a0000000-0001-4000-a000-000000000004', 'Mopani Site-to-Site VPN', 62000, 'Negotiation', 70, 'Gold', 'Mwape Kasonde', '2026-08-01', '2026-05-25'),
  ('o0000000-0001-4000-a000-000000000006', 'c0000000-0001-4000-a000-000000000004', 'a0000000-0001-4000-a000-000000000006', 'Sun Hotel WiFi Overhaul', 35000, 'Qualified', 35, 'Bronze', 'Thandiwe Mumba', '2026-10-01', '2026-06-18'),
  ('o0000000-0001-4000-a000-000000000007', 'c0000000-0001-4000-a000-000000000003', 'a0000000-0001-4000-a000-000000000003', 'Zambeef MPLS Upgrade', 125000, 'Closed Won', 100, 'Gold', 'Mwape Kasonde', '2026-04-30', '2026-03-05');

-- ─── 6. Contracts (4 rows) ──────────────────────────────────────────────────
INSERT INTO contracts (id, opportunity_id, campaign_id, account_id, name, amount, status, signed_date, start_date, end_date) VALUES
  ('ct000000-0001-4000-a000-000000000001', 'o0000000-0001-4000-a000-000000000004', 'c0000000-0001-4000-a000-000000000005', 'a0000000-0001-4000-a000-000000000005', 'ZANACO Branch Connectivity 2026', 310000, 'Active', '2026-03-20', '2026-04-01', '2027-03-31'),
  ('ct000000-0001-4000-a000-000000000002', 'o0000000-0001-4000-a000-000000000007', 'c0000000-0001-4000-a000-000000000003', 'a0000000-0001-4000-a000-000000000003', 'Zambeef MPLS Service Agreement', 125000, 'Active', '2026-05-01', '2026-05-15', '2027-05-14'),
  ('ct000000-0001-4000-a000-000000000003', NULL, 'c0000000-0001-4000-a000-000000000001', 'a0000000-0001-4000-a000-000000000001', 'KCM Dedicated Fibre (Existing)', 420000, 'Active', '2025-01-15', '2025-02-01', '2026-07-31'),
  ('ct000000-0001-4000-a000-000000000004', NULL, NULL, 'a0000000-0001-4000-a000-000000000004', 'Mopani Internet Service', 45000, 'Expiring', '2025-06-01', '2025-07-01', '2026-06-30');
...
INSERT INTO quotations (opportunity_id, account_id, name, total_amount, status, valid_until, notes) VALUES
  ('o0000000-0001-4000-a000-000000000001', 'a0000000-0001-4000-a000-000000000001', 'KCM Phase 2 — Fibre + Managed Services', 280000, 'Sent', '2026-08-31', 'Includes 3-year term discount'),
  ('o0000000-0001-4000-a000-000000000005', 'a0000000-0001-4000-a000-000000000004', 'Mopani VPN Solution Quote', 62000, 'Draft', '2026-08-15', 'Awaiting technical validation'),
  ('o0000000-0001-4000-a000-000000000006', 'a0000000-0001-4000-a000-000000000006', 'Sun Hotel WiFi Package', 35000, 'Sent', '2026-09-30', 'Includes Ubiquiti APs and installation');
...
INSERT INTO invoices (contract_id, account_id, invoice_number, amount, paid_amount, status, due_date, paid_date) VALUES
  ('ct000000-0001-4000-a000-000000000001', 'a0000000-0001-4000-a000-000000000005', 'INV-2026-001', 77500, 77500, 'Paid', '2026-04-30', '2026-04-28'),
  ('ct000000-0001-4000-a000-000000000001', 'a0000000-0001-4000-a000-000000000005', 'INV-2026-002', 77500, 77500, 'Paid', '2026-07-31', '2026-07-20'),
  ('ct000000-0001-4000-a000-000000000002', 'a0000000-0001-4000-a000-000000000003', 'INV-2026-003', 62500, 30000, 'Partial', '2026-06-15', NULL),
  ('ct000000-0001-4000-a000-000000000003', 'a0000000-0001-4000-a000-000000000001', 'INV-2026-004', 105000, 0, 'Pending', '2026-06-30', NULL),
  ('ct000000-0001-4000-a000-000000000004', 'a0000000-0001-4000-a000-000000000004', 'INV-2026-005', 22500, 0, 'Pending', '2026-06-15', NULL);
